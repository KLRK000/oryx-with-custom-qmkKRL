...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_TAB,         KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPC,
    KC_CAPS,        KC_Q,           TD(DANCE_0),    TD(DANCE_1),    KC_P,           TD(DANCE_2),    KC_ESCAPE,                                      TD(DANCE_13),   KC_J,           KC_L,           KC_U,           KC_Y,           TD(DANCE_14),   TD(DANCE_15),
    OSM(MOD_LSFT),  TD(DANCE_3),    KC_R,           TD(DANCE_4),    TD(DANCE_5),    KC_G,                                                                           KC_M,           KC_N,           KC_E,           KC_I,           KC_O,           KC_ENTER,
    OSM(MOD_LGUI),  TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    KC_D,           TD(DANCE_9),    TT(1),                                          TD(DANCE_16),   KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_SHIFT,
    OSM(MOD_LCTL),  KC_LEFT_ALT,    OSM(MOD_LGUI),  KC_SPACE,       TD(DANCE_10),                                                                                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_RGUI),  OSM(MOD_RCTL),
                                                                                                    TD(DANCE_11),   LCTL(KC_UP),    KC_UP,          KC_DOWN,
                                                                                                                    TT(3),          KC_LEFT,
                                                                                    KC_SPACE,       KC_BSPC,        TD(DANCE_12),   KC_RIGHT,       KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_LEFT,                                        KC_RIGHT,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_TRANSPARENT,
    KC_TRANSPARENT, KC_Q,           TD(DANCE_17),   KC_E,           KC_R,           KC_T,           TG(2),                                          TG(2),          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_TRANSPARENT,
    KC_TRANSPARENT, KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(3,KC_SCLN),  KC_LEFT_GUI,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_UP,          KC_DOWN,        KC_LBRC,        KC_RBRC,        MO(2),
...
const uint16_t PROGMEM combo0[] = { KC_TAB, KC_CAPS, COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_TAB, KC_1, COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_TAB, KC_2, COMBO_END};
const uint16_t PROGMEM combo3[] = { KC_TAB, KC_4, COMBO_END};
const uint16_t PROGMEM combo4[] = { KC_SPACE, KC_BSPC, COMBO_END};
const uint16_t PROGMEM combo5[] = { KC_K, KC_H, COMBO_END};
...
void dance_10_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[10].step) {
        ...
        case DOUBLE_HOLD: register_code16(LCTL(LSFT(KC_TAB))); break;
...
void dance_10_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[10].step) {
        ...
        case DOUBLE_HOLD: unregister_code16(LCTL(LSFT(KC_TAB))); break;
